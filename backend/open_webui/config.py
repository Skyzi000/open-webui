...
CONTEXT_COMPACTION_SOFT_TRIGGER_RATIO = float(
    os.getenv('CONTEXT_COMPACTION_SOFT_TRIGGER_RATIO', '0.5')
)

ENABLE_EXTERNALIZED_REFS = os.getenv('ENABLE_EXTERNALIZED_REFS', 'False').lower() == 'true'

EXTERNALIZED_REFS_TOKEN_THRESHOLD = int(os.getenv('EXTERNALIZED_REFS_TOKEN_THRESHOLD', '10000'))

CONTEXT_COMPACTION_TRANSIENT_MESSAGE_PATTERNS = os.getenv(
...
DEFAULT_CONFIG = {
    ...
    'chat.context_compaction.soft_trigger_ratio': CONTEXT_COMPACTION_SOFT_TRIGGER_RATIO,
    'chat.context_compaction.transient_message_patterns': CONTEXT_COMPACTION_TRANSIENT_MESSAGE_PATTERNS,
    'chat.externalized_refs.enable': ENABLE_EXTERNALIZED_REFS,
    'chat.externalized_refs.token_threshold': EXTERNALIZED_REFS_TOKEN_THRESHOLD,
